...
const transformCountryIsoCode = function(gtmIsoCode){
...
const transformGtmHits = function(data){
    ...
    var retval = [];
    if(data.gtmData.data == null || data.gtmData.data.rows == null) return retval;
    ...
    data.gtmData.data.rows.forEach(row => {
        ...
        sourceObj.statistics.push({
            ...
            "originatingCountry": transformCountryIsoCode(countryIsoCode)
        })
